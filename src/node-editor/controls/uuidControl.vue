...
export default {
  ...
  // {"type":"MetaRoot","id":1,"parameters":{"name":{"name":"if","id":168},"transform":{"position":{"x":0,"y":0,"z":0},"rotate":{"x":0,"y":0,"z":0},"scale":{"x":1,"y":1,"z":1}},"active":true},"chieldren":{"entities":[{"type":"Polygen","id":2,"parameters":{"uuid":"001dcb90-871e-4515-8e65-e9e1bcf1ee8f","name":"is","transfrom":{"position":{"x":0,"y":0,"z":0},"rotate":{"x":0,"y":0,"z":0},"scale":{"x":1,"y":1,"z":1}},"active":true,"polygen":35},"chieldren":{"entities":[],"components":[]}},{"type":"Entity","id":3,"parameters":{"name":"clay","transfrom":{"position":{"x":0,"y":0,"z":0},"rotate":{"x":0,"y":0,"z":0},"scale":{"x":1,"y":1,"z":1}},"active":true},"chieldren":{"entities":[],"components":[]}}],"addons":[]}}
  data() {
    return {
      value: uuidv4()
    }
